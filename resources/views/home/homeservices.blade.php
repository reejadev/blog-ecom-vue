            ...
            @if(isset($post) && !empty($post))
                ...
                <div class="col-md-4">
                    <div style="width: 300px; height: 200px; border: 1px solid #ccc; overflow: hidden;">
                        <img src="/postimage/{{$posts->image}}" class="services_img" style="width: 100%; height: 100%; object-fit: cover;">
                    </div>
                    <h1 style="font-size: 24px;">{{$posts->title}}</h1>
                    <p><b>Post by {{$posts->name}}</b></p>
                    <div class="btn_main" style="padding-bottom: 100px;" ><a href="{{url('/desc_page',$posts->id)}}">Read More...</a></div>
