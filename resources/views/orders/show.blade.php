...
@endforeach
            ...
            <div class="lg:col-span-2">
                ...
                <div class="flex items-center justify-between mb-5">
                    ...
                    <input type="number" name="quantity" x-ref="quantityEl" min="1" value="{{ $product->quantity }}"
                ...
                <div class="mb-6" x-data="{expanded: false}">
                    <div x-show="expanded" x-collapse.min.120px class="text-gray-500 wysiwyg-content">
                        ...
                        <ul class="list-disc pl-6">
                            ...
                            <!-- @foreach(explode(',',str_replace("'", '', $product->description)) as $point)
                                <li>{{ trim($point) }}</li>
@endforeach-->

                            @php
                            $cleanedDescription = str_replace(['&quot;', '&rsquo;'], "'", $product->description);
                            @endphp

                            @foreach(explode(',', $cleanedDescription) as $point)
                            <li>{{ trim($point) }}</li>
                            @endforeach
