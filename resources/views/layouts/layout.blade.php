...
<body>
    ...
    cartItemsCount:{{ \App\Http\Helpers\Cart::getCartItemsCount() }}
        ...
        <!-- Responsive Menu -->
        <div class="block fixed z-10 top-0 bottom-0 h-full w-[220px] transition-all bg-slate-900 md:hidden"
            ...
            <ul>
                ...
                <li>
                    <a href="#" class="block py-2 px-3 transition-colors hover:bg-slate-800">Search</a>
                </li>
            </ul>
            <ul>
                <li>
                    <a href="{{ route('cart.index') }}"
                        ...
                        <small x-show="cartItemsCount > 0" x-transition x-text="cartItemsCount"
                            class="py-[2px] px-[8px] rounded-full bg-red-500"></small>
                        <!--/ Cart Items Counter -->
                    </a>
                </li>
        ...
        <nav class="hidden md:block">
            <ul class="grid grid-flow-col">
                ...
                <li>
                    <a href="#" class="block py-navbar-item px-navbar-item hover:bg-slate-900">Search</a>
                </li>
            </ul>
        </nav>
        <nav class="hidden md:block">
            <ul class="grid grid-flow-col items-center">
                <li>
                    <a href="{{ route('cart.index') }}"
                        ...
                        <small x-show="cartItemsCount >0" x-transition x-cloak x-text="cartItemsCount"
